...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routeConfig = __webpack_require__(301);
	...
	var _vueResource = __webpack_require__(328);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] src\\js\\components\\events.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "C:\\Users\\pedro.silva\\Pessoal\\Vue\\express-be\\src\\js\\components\\events.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./events.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./events.vue");
	...
	exports.default = {
	  route: {
	    data: function data(transition) {
	      return _users2.default.getUsers(this).then(function (data) {
	        return { users: data };
	      });
	    }
	  },
...
/***/ function(module, exports) {
	...
	var TASK_API_URL = 'api/users';

	exports.default = {
	  getUsers: function getUsers(context) {
	    return context.$http.get(TASK_API_URL).then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\js\\components\\app.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "C:\\Users\\pedro.silva\\Pessoal\\Vue\\express-be\\src\\js\\components\\app.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	//       <a v-link="{ path: '/events' }">Eventos</a>
	//       <a v-link="{ path: '/about' }">Sobre</a>
	//
	//       <div class="container">
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "C:\\Users\\pedro.silva\\Pessoal\\Vue\\express-be\\src\\js\\components\\navbar.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\r\n.logo{\r\n\tmax-height:42px;\r\n}\r\n\r\nhtml,body {\r\n\theight:100%;\r\n  /*padding-top:70px;*/\r\n}\r\n/*moving navbar*/\r\nsection {\r\n  height:calc(90% - 50px);\r\n}\r\n\r\n.affix {\r\n  padding:0px;\r\n  -webkit-transition:padding 0.2s linear;\r\n  transition:padding 0.2s linear;\r\n\r\n}\r\n\r\n.affix-top {\r\n  padding-top:15px;\r\n  padding-bottom:15px;\r\n  -webkit-transition:padding 0.5s linear;\r\n  transition:padding 0.5s linear;\r\n}\r\n\r\n/* The company logo */\r\n.navbar{\r\n  color:  #ffffff;\r\n  font: normal 18px 'Jockey One', sans-serif;\r\n  margin: 0 0 10px;\r\n  padding-left: 15px;\r\n  padding-right: 15px;\r\n}\r\n\r\n@media (max-width: 800px) {\r\n\r\n  .navbar-brand{\r\n    font-size: 16px;\r\n  }\r\n  .navbar-toggle{\r\n    margin-right: 0px;\r\n  }\r\n}\r\n\r\n", ""]);
...
/***/ function(module, exports) {
	...
	//             Clube de Praticantes PeraltaBTT</a>
	//         </div>
	//         <div id="navbar" class="navbar-collapse collapse">
	//           <ul class="nav navbar-nav navbar-right">
	//             <li v-link-active><a v-link="{ path: '/', exact: true, activeClass:'active' }">Início</a></li>
	//             <li v-link-active><a v-link="{ path: '/about', exact: true, activeClass:'active' }">Sobre nós</a></li>
	//             <li v-link-active><a v-link="{ path: '/contact', exact: true, activeClass:'active' }">Contacto</a></li>
	//           </ul>
	//         </div><!--/.nav-collapse -->
	//       </div>
	//     </nav>
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\js\\components\\login.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "C:\\Users\\pedro.silva\\Pessoal\\Vue\\express-be\\src\\js\\components\\login.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stringify = __webpack_require__(320);
	...
	exports.default = {
	  methods: {
	    login: function login() {
	      var lock = new Auth0Lock(_config2.default.auth0.id, _config2.default.auth0.domain);
	      console.log(lock);
...
/***/ function(module, exports) {
	...
	module.exports = {
		"auth0": {
			"id": "0bdUDrdtUY0giSKDiesTGk7HhHSsXnWh",
			"domain": "mackadelic.eu.auth0.com"
		},
		"development": {
			"username": "postgres",
			"password": "vbc7lh*r",
		...
		"production": {
			"username": "adminpvn5l3c",
			"password": "v7YHeZKXL4H2",
			"database": "expressapp",
			"host": "127.0.0.1",
			"port": "5432",
			"dialect": "postgres",
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\js\\components\\footer.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "C:\\Users\\pedro.silva\\Pessoal\\Vue\\express-be\\src\\js\\components\\footer.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	// 			<h3><img class="logo" src="/images/logo.png">Peralta<span>BTT</span></h3>
	...
	// 				<a href="#">Contacto</a>
	// 			</p>
	// 			<div class="developed-by">Desenvolvido por <a><u>Pedro Silva</u></a></div>						
	// 		</div>
	// 		<div class="footer-right">
	// 			<div>
	// 				<i class="fa fa-map-marker"></i>
	// 				<p><a href="https://goo.gl/maps/Rtp3MryFrRJ2" target="_blank">Praceta do Prado, Lote 8, n.º 11
	// 3270-093 Pedrógão Grande</a></p>
	// 			</div>
	// 			<div>
	// 				<i class="fa fa-facebook"></i>
	// 				<p><a href="http://facebook.com/PeraltaBTT/"  target="_blank">PeraltaBTT</a></p>
	// 			</div>
	// 			<div>
	// 				<i class="fa fa-envelope"></i>
	// 				<p><a href="mailto:peraltabtt@gmail.com">peraltabtt@gmail.com</a></p>
	// 			</div>
	// 		</div>
	// 	</footer>
	// 		<!--<div class="container">
	// 			<div class="section text-center">
	// 		<p>Clube de Praticantes PeraltaBTT, Pedrógão Grande</p>
	// <p>Desenvolvido por <a><u>Pedro Silva</u></a></p>
	// 			</div>
	// 		</div>
	// 	</footer>-->
	...
	// 								<svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#shape-twitter"></use></svg>
	// 							</a>
	// 						</li>
	// 						<li>
	// 							<a href="http://instagram.com/agra_culture" target="_blank">
	// 								<svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#shape-instagram"></use></svg>
	// 							</a>
	// 						</li>
	// 						<li>
	// 							<a href="https://www.facebook.com/agraculture" target="_blank">
	// 								<svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#shape-facebook"></use></svg>
	// 							</a>
	// 						</li>
	// 					</ul>
	// 					<p class="h5 text-white">HEALTHY FAST-CASUAL FOOD, CRAFTED WITH <span class="shape-heart"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#shape-heart"></use></svg></span> IN MINNEAPOLIS</p>
	// 				</div>
	// 			</div>
	// 		</div>
	// 		<div class="wrapperFull wrapperFull--dust-brand">
	// 			<div class="wrapper wrapper--thin section section--short text-center">
	// 				<p class="p-sm text-white">© Agra Culture Kitchen &amp; Press. All Rights Reserved.</p>
	// 			</div>
	// 		</div>
	// 	</footer>-->
...
/***/ function(module, exports, __webpack_require__) {
	...
	function install(Vue) {
	    ...
	    Vue.url = __webpack_require__(330);
	    Vue.http = __webpack_require__(336);
	    Vue.resource = __webpack_require__(351);
	    Vue.Promise = __webpack_require__(338);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UrlTemplate = __webpack_require__(332);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Promise = __webpack_require__(338);
	var interceptor = __webpack_require__(341);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(329);
	var Promise = __webpack_require__(338);
	var xhrClient = __webpack_require__(340);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(329);
	var PromiseObj = window.Promise || __webpack_require__(339);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jsonpClient = __webpack_require__(345);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(329);
	var xdrClient = __webpack_require__(350);
